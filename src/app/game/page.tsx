  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-900 text-white">
      ...
      <main className="flex-grow flex items-center justify-center p-2 sm:p-4 lg:p-6">
        <div className="bg-gray-800 border border-gray-700 rounded-lg overflow-auto w-full max-w-[90vw] max-h-[100vh] lg:overflow-hidden lg:transform lg:scale-75 lg:origin-top">
